...
<html>
		...
		<head>
			<title> Kika's Kitchen</title>
			<link rel="stylesheet" type="text/css" href="kikaskitchen_format.css?v=1" />
		</head>
...
?>
		...
		<body>
			...
			*/?>
			...
			<form name='fromLogin' method="post" action="kikaskitchen_register.php"> 
			...
			<br>
				<br>
				<form action = "kikaskitchen_homepage.php" method = 'POST'>
